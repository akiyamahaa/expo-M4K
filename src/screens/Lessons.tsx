...
import { ELessonType } from '../types/utils'
        ...
        <VStack flex={1} justifyContent={'center'} alignItems={'center'}>
          <HStack alignItems={'center'} justifyContent={'space-between'} px={5}>
            ...
            <TouchableOpacity>
              <ArrowRight3
                size="36"
                color={lessonIdx >= Object.keys(lessons).length - 1 ? '#cecece' : '#fff'}
                variant="Bold"
                onPress={() => setLessonIdx(lessonIdx + 1)}
          ...
          <HStack width="60%" mt={1} justifyContent={'space-between'} alignItems={'center'}>
            <VStack>
              ...
              <HStack alignItems={'center'} space={1}>
                <Box width={'80%'}>
                  <Text color="white" fontSize={16} ellipsizeMode="tail" numberOfLines={2}>
